...
public class testRemoveDup extends TestCase {
	...
	{
		Node toRemove = list2.next.next.next;
		...
		toRemove.removeMiddleNode();
		assertTrue(Node.is_equal(list2, reference));
	}
	
	public void testPartition()
	{
		Node head = Node.partitionX(list1, 4);
		assertTrue(Node.findKthToLastIterative(head, 3).data == 4);
